...
public class Main {
    ...
    public static void main(String[] args) {
        books.add(new Book("388c-e681-9152", "Galaksi", "Poppi Pertiwi", "Romance", 5));
        books.add(new Book("ed90-be30-5cdb", "Modul 2", "Taufiq Ramadhan", "Informatics", 3));
        books.add(new Book("d95e-0c4a-9523", "Kera Sakti", "Galang", "Advanture", 5));
...
class Student {
    ...
    public void borrowBook(ArrayList<Book> books, Scanner scanner) {
        System.out.println("~ List ID Buku ~");
        System.out.println("1. 388c-e681-9152");
        System.out.println("2. ed90-be30-5cdb");
        System.out.println("3. d95e-0c4a-9523");

        System.out.print("Masukkan ID buku yang ingin dipinjam ( 99 for Back to menu ): ");
